<?php $title ='Washing Machine Owners' ?>
@extends('layouts.app')
    @section('content')
    ...
    <div class="col-lg-12 mb12">
		...
		<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-bold" style="color:blue">
			...
			<li class="nav-item">
				<a class="nav-link" href="{{route('washing.index')}}" data-toggle="false">
					<i class="fe fe-file mr-1"></i>
					Washing Machine Owners
				</a>
            </li>
            <li class="nav-item">
			...
			<li class="nav-item">
				<a class="nav-link disabled" href="javascript: void(0);" data-toggle="false">
					...
					List of Washing Machine owners
				</a>
			</li>
            ...
            @if(count($washing) > 0)
                <div class="card">
                    ...
                    <div class="card-body" style="backgroud-color:gray">
                        ...
                        <h6 class="mb-4">
                            <strong>List of All Washing Machine Owners</strong>
                        </h6>
                        ...
                        <table class="table table-hover table-bordered nowrap" id="example1">
                            <small>
                                ...
                                <tbody>
                                    <?php $number =1; ?>
                                    @foreach($washing as $machine)<?php

                                        $houseHold = get_house_hold_infomations($machine->data_id);
