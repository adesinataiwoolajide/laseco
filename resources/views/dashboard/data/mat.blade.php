...
@extends('layouts.app')
    ...
    <div class="col-lg-12 mb12">
		...
		<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-bold" style="color:blue">
			...
			<li class="nav-item">
				<a class="nav-link" href="{{route('mat.index')}}" data-toggle="false">
            ...
            @if(count($mat) > 0)
                <div class="card">
                    ...
                    <div class="card-body" style="backgroud-color:gray">
                        ...
                        <h6 class="mb-4">
                            <strong>List of All Mattress Owners</strong>
                        </h6>
                        ...
                        <table class="table table-hover table-bordered nowrap" id="example1">
                            <small>
                                ...
                                <tbody>
                                    <?php $number =1; ?>
                                    @foreach($mat as $mats)<?php

                                        $houseHold = get_house_hold_infomations($mats->data_id);
