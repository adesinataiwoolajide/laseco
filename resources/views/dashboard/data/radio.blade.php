            ...
            @if(count($radio) > 0)
                <div class="card">
                    ...
                    <div class="card-body" style="backgroud-color:gray">
                        ...
                        <h6 class="mb-4">
                            <strong>List of All Radio Owners</strong>
                        </h6>
                        ...
                        <table class="table table-hover table-bordered nowrap" id="example1">
                            <small>
                                ...
                                <tbody>
                                    <?php $number =1; ?>
                                    @foreach($radio as $radios)<?php

                                        $houseHold = get_house_hold_infomations($radios->data_id);
