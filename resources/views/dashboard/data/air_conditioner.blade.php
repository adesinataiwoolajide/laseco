<?php $title ='Air Condition Owners' ?>
@extends('layouts.app')
    @section('content')
    ...
    <div class="col-lg-12 mb12">
		...
		<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-bold" style="color:blue">
			...
			<li class="nav-item">
				<a class="nav-link" href="{{route('ac.index')}}" data-toggle="false">
            ...
            @if(count($air_conditioner) > 0)
                <div class="card">
                    ...
                    <div class="card-body" style="backgroud-color:gray">
                        ...
                        <h6 class="mb-4">
                            <strong>List of All Air Condition Owners</strong>
                        </h6>
                        ...
                        <table class="table table-hover table-bordered nowrap" id="example1">
                            <small>
                                ...
                                <tbody>
                                    <?php $number =1; ?>
                                    @foreach($air_conditioner as $air_conditioners)<?php

                                        $houseHold = get_house_hold_infomations($air_conditioners->data_id);
