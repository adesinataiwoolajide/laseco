...
@extends('layouts.app')
    ...
    <div class="col-lg-12 mb12">
		...
		<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-bold" style="color:blue">
            ...
            <li class="nav-item">
				<a class="nav-link" href="{{route('television.index')}}" data-toggle="false">
					<i class="fe fe-file mr-1"></i>
					Television Owners
				</a>
            </li>
			<li class="nav-item">
				<a class="nav-link" href="{{route('radio.index')}}" data-toggle="false">
					<i class="fe fe-file mr-1"></i>
					Radio Owners
				</a>
            </li>
    ...
    <div class="air__layout__content">
        <div class="air__utils__content">
            ...
            @if(count($television) > 0)
                <div class="card">

                    <div class="card-body" style="backgroud-color:gray">

                        <h6 class="mb-4">
                            <strong>List of All Television Owners</strong>
                        </h6>
                        ...
                        <table class="table table-hover table-bordered nowrap" id="example1">
                            <small>
                                ...
                                <tbody>
                                    <?php $number =1; ?>
                                    @foreach($television as $televisions)<?php

                                        $houseHold = get_house_hold_infomations($televisions->data_id);
