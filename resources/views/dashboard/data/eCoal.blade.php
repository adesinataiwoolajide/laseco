<?php $title ='Charcoal Iron Owners' ?>
@extends('layouts.app')
    @section('content')
            ...
            @if(count($cIron) > 0)
                <div class="card">
                    ...
                    <div class="card-body" style="backgroud-color:gray">
                        ...
                        <h6 class="mb-4">
                            <strong>List of All Charcoal Iron Owners</strong>
                        </h6>
                        ...
                        <table class="table table-hover table-bordered nowrap" id="example1">
                            <small>
                                ...
                                <tbody>
                                    <?php $number =1; ?>
                                    @foreach($cIron as $cIrons)<?php

                                        $houseHold = get_house_hold_infomations($cIrons->data_id);
