<?php $title ='Electric Iron Owners' ?>
@extends('layouts.app')
    @section('content')
    ...
    <div class="col-lg-12 mb12">
		...
		<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-bold" style="color:blue">
			...
			<li class="nav-item">
				<a class="nav-link" href="{{route('iron.elec')}}" data-toggle="false">
					<i class="fe fe-file mr-1"></i>
					Electric Iron Owners
				</a>
            </li>
            <li class="nav-item">
				<a class="nav-link" href="{{route('iron.coal')}}" data-toggle="false">
					<i class="fe fe-file mr-1"></i>
					Charcoal Iron Owners
				</a>
            </li>
            <li class="nav-item">
            ...
            @if(count($eIron) > 0)
                <div class="card">
                    ...
                    <div class="card-body" style="backgroud-color:gray">
                        ...
                        <h6 class="mb-4">
                            <strong>List of All Electric Iron Owners</strong>
                        </h6>
                        ...
                        <table class="table table-hover table-bordered nowrap" id="example1">
                            <small>
                                ...
                                <tbody>
                                    <?php $number =1; ?>
                                    @foreach($eIron as $eIrons)<?php

                                        $houseHold = get_house_hold_infomations($eIrons->data_id);
