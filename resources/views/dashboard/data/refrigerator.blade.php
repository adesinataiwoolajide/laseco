...
@extends('layouts.app')
    ...
    <div class="col-lg-12 mb12">
		...
		<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-bold" style="color:blue">
			...
			<li class="nav-item">
				<a class="nav-link" href="{{route('refrigerator.index')}}" data-toggle="false">
					<i class="fe fe-file mr-1"></i>
					Refrigerator Owners
				</a>
            </li>
            <li class="nav-item">
				<a class="nav-link" href="{{route('frezer.index')}}" data-toggle="false">
					<i class="fe fe-file mr-1"></i>
					Freezer Owners
				</a>
            </li>
            ...
            @if(count($refrigerator) > 0)
                <div class="card">
                    ...
                    <div class="card-body" style="backgroud-color:gray">
                        ...
                        <h6 class="mb-4">
                            <strong>List of All Refrigerator Owners</strong>
                        </h6>
                        ...
                        <table class="table table-hover table-bordered nowrap" id="example1">
                            <small>
                                ...
                                <tbody>
                                    <?php $number =1; ?>
                                    @foreach($refrigerator as $refrigerators)<?php

                                        $houseHold = get_house_hold_infomations($refrigerators->data_id);
